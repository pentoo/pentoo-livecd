...
livecd/iso: /tmp/pentoo-x86_64-2011.0-minimal.iso
...
# example:
# livecd/rcadd:
livecd/rcadd: autoconfig|default acpid|default gpm|default dbus|default microcode_ctl|boot
...
boot/kernel/pentoo/sources: ~pentoo-sources-2.6.36
...
boot/kernel/pentoo/config: /var/svn/pentoo/livecd/trunk/amd64/kernel/config-2.6.36
...
-analyzer -bluetooth cracking -database enlightenment -exploit -forensics -mitm -proxie
