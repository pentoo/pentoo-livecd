...
mkdir -p /dev/shm/distfiles/rootfs/usr/portage/distfiles/ || exit
...
mksquashfs /dev/shm/distfiles/rootfs/usr/portage/distfiles/ /usr/src/pentoo/livecd/trunk/isoroot/modules/zdistfiles-`date "+%Y%m%d"`.lzm -comp xz -Xbcj x86 -b 1048576 -Xdict-size 1048576 -no-recovery -noappend || exit
